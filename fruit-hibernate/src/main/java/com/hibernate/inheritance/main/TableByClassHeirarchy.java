...
public class TableByClassHeirarchy {
	public static void main(String[] args) {
		Session session = HibernateSessionManagerUtil.getHibernateSession();
		
		System.out.println("________________________________________________________");
		System.out.println("_________Implementation of Table per class heirarchy_____");
		System.out.println("________________________________________________________");
		...
		System.out.println("_______Implemented table per class heirarchy________");
	}
}
