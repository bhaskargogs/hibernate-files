...
public class TableByConcreteClass {
	public static void main(String[] args) {
		Session session = HibernateSessionManagerUtil.getHibernateSession();
		
		System.out.println("________________________________________________________");
		System.out.println("_________Implementation of Table per concrete class_____");
		System.out.println("________________________________________________________");
		...
		System.out.println("The order is in the database");
		System.out.println("_____Implemented Table per Concrete Class_____");
	}
}
